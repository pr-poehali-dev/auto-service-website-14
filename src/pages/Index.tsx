...
const services = [
  ...
  },
  {
    ...
    desc: "Устранение вмятин, царапин, покраска деталей. Работаем со всеми марками.",
    price: "от 3 000 ₽",
  },
  {
    icon: "Gauge",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { icon: "CheckCircle2", title: "Гарантия на все работы", desc: "Даём письменную гарантию на все виды ремонта и запчасти" },
